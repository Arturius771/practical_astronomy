...
class CoordinateTestMethods(unittest.TestCase):
  ...
  def test_right_ascension_to_hour_angle(self):
    ...
    self.assertEqual(coordinate_functions.right_ascension_to_hour_angle(at.Time((18,32,21)),full_date,0,-4,-64), (9, 52, 23.66), msg)
  ...
  def test_equatorial_to_ecliptic_coordinates(self):
    ...
    coordinates = at.EquatorialCoordinates((at.Declination(at.Degrees((19,32,8.52))), at.Time((9,34,53.4))))
  ...
  def test_equatorial_to_galactic_coordinates(self):
    ...
    coordinates = at.EquatorialCoordinates((at.Declination(at.Degrees((10,3,11))), at.Time((10,21,0))))
