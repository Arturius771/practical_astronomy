...
class CoordinateTestMethods(unittest.TestCase):
  ...
  def test_equatorial_coordinates_to_horizon_coordinates(self):
    msg = 'test_equatorial_coordinates_to_horizon_coordinates fail'

    self.assertEqual(coordinate_functions.equatorial_coordinates_to_horizon_coordinates(5,51,44,23,13,10,52), (283,16,15.7,19,20,3.64), msg)

  def test_horizon_coordinates_to_equatorial_coordinates(self):
    msg = 'test_horizon_coordinates_to_equatorial_coordinates fail'

    self.assertEqual(coordinate_functions.horizon_coordinates_to_equatorial_coordinates(283,16,15.76,19,20,3.64,52), (5,51,44.0,23,13,10.04), msg)
