...
def degrees_to_decimal_degrees(angle: int, minutes: int, seconds: int) -> float:
...
def decimal_degrees_to_degrees(decimal_degree: float) -> tuple:
...
def right_ascension_to_hour_angle(right_ascension_hours: int, right_ascension_minutes: int, right_ascension_seconds: float, local_hours: int, local_minutes: int, local_seconds: float, daylight_savings: int, zone_correction: int, local_day: int, local_month: int, local_year: int, longitude: float) -> tuple:
  ...
  lst = degrees_to_decimal_degrees(lst_hours, lst_minutes, lst_seconds)
  ra_decimal = degrees_to_decimal_degrees(right_ascension_hours,right_ascension_minutes,right_ascension_seconds)
...
def hour_angle_to_right_ascension(hour_angle_hour: int, hour_angle_minutes: int, hour_angle_seconds: float, local_hours: int, local_minutes: int, local_seconds: float, daylight_savings: int, zone_correction: int, local_day: int, local_month: int, local_year: int, longitude: float) -> tuple:
  ...
  gst_hours, gst_minutes, gst_seconds = time_functions.universal_to_greenwich_sidereal_time(greenwich_year,greenwich_month,greenwich_day,utc_hour,utc_minute,utc_second)
  lst_hours, lst_minutes, lst_seconds = time_functions.greenwich_sidereal_to_local_sidereal_time(gst_hours, gst_minutes, gst_seconds, longitude)
  local_siderial_time = degrees_to_decimal_degrees(lst_hours, lst_minutes, lst_seconds)
  ha_decimal = degrees_to_decimal_degrees(hour_angle_hour,hour_angle_minutes,hour_angle_seconds)
...
def equatorial_to_horizon_coordinates(hour_angle_hour: int, hour_angle_minutes: int, hour_angle_seconds: float, declination_degrees: int, declination_minutes: int, declination_seconds: float, latitude: float) -> tuple:
  ...
  declination_decimal = degrees_to_decimal_degrees(declination_degrees, declination_minutes, declination_seconds)
  ...
  azimuth_degrees, azimuth_minutes, azimuth_seconds = decimal_degrees_to_degrees(azimuth_degrees)
  altitude_degrees, altitude_minutes, altitude_seconds = decimal_degrees_to_degrees(altitude_degrees)
...
def horizon_to_equatorial_coordinates(azimuth_degrees: int, azimuth_minutes: int, azimuth_seconds: float, altitude_degrees: int, altitude_minutes: int, altitude_seconds:float, latitude: float) -> tuple:
  azimuth_decimal = degrees_to_decimal_degrees(azimuth_degrees, azimuth_minutes, azimuth_seconds)
  altitude_decimal = degrees_to_decimal_degrees(altitude_degrees, altitude_minutes, altitude_seconds)
...
def ecliptic_to_equatorial_coordinates(ecliptic_longitutde_degrees: int, ecliptic_long_minutes: int, ecliptic_long_seconds: float, ecliptic_latitude_degrees: int, ecliptic_latitude_minutes: int, ecliptic_latitude_seconds: float, greenwich_year: int, greenwich_month: int, greenwich_day: int) -> tuple:
  eclon_deg = degrees_to_decimal_degrees(ecliptic_longitutde_degrees, ecliptic_long_minutes, ecliptic_long_seconds)
  eclat_deg = degrees_to_decimal_degrees(ecliptic_latitude_degrees, ecliptic_latitude_minutes, ecliptic_latitude_seconds)
  ...
  right_ascension_hour, right_ascension_min, right_ascension_seconds  = decimal_degrees_to_degrees(reight_ascension_hms)
  declination_hours, declination_minutes, declination_seconds = decimal_degrees_to_degrees(declination_deg)
...
def equatorial_to_ecliptic_coordinates(right_ascension_hours: int, right_ascension_minutes: int, right_ascension_seconds: float, declination_degrees: int, declination_minutes: int, declination_second: float, greenwich_year: int, greenwich_month: int, greenwich_day: int) -> tuple:
  right_ascension_degrees = degrees_to_decimal_degrees(right_ascension_hours, right_ascension_minutes, right_ascension_seconds) * 15
  declination_deg = degrees_to_decimal_degrees(declination_degrees, declination_minutes, declination_second)
  ...
  ecliptic_longitude_degrees, ecliptic_longitude_minutes, ecliptic_longitude_seconds = decimal_degrees_to_degrees(ecliptic_long_deg_corrected) 
  ecliptic_latitude_degrees, ecliptic_latitude_minutes, ecliptic_latitude_seconds = decimal_degrees_to_degrees(ecliptic_lat_deg) 
